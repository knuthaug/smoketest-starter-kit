...
public class PersonIntegrationTest {
    ...
    public void testCountPeople() {
        ...
        long count = smoketests.demo.domain.Person.countPeople();
        org.junit.Assert.assertTrue("Counter for 'Person' incorrectly reported there were no entries", count > 0);
    }

	@Test
    public void testFindPerson() {
        smoketests.demo.domain.Person obj = dod.getRandomPerson();
        ...
        obj = smoketests.demo.domain.Person.findPerson(id);
    ...
    public void testFindAllPeople() {
        ...
        java.util.List<smoketests.demo.domain.Person> result = smoketests.demo.domain.Person.findAllPeople();
    ...
    public void testFindPersonEntries() {
        ...
        java.util.List<smoketests.demo.domain.Person> result = smoketests.demo.domain.Person.findPersonEntries(0, (int) count);
    ...
    public void testMerge() {
        ...
        boolean modified =  dod.modifyPerson(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        smoketests.demo.domain.Person merged =  obj.merge();
        obj.flush();
    ...
    public void testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Person' failed to initialize correctly", dod.getRandomPerson());
        smoketests.demo.domain.Person obj = dod.getNewTransientPerson(Integer.MAX_VALUE);
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", smoketests.demo.domain.Person.findPerson(id));
    }
}
